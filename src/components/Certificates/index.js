    ...
    return (
        <Container id='certificate'>
            ...
            <ToggleButtonGroup>
                ...
                <Divider />
                {toggle === 'Data Oriented Learning' ?
                    <ToggleButton active value="Data Oriented Learning" onClick={() => setToggle('Data Oriented Learning')}>Data Oriented Learning</ToggleButton>
                    :
                    <ToggleButton value="Data Oriented Learning" onClick={() => setToggle('Data Oriented Learning')}>Data Oriented Learning</ToggleButton>
                }
                <Divider />
